...
function Patientsform() {
    return (
        <>
            ...
            <p className='text-[#082161] font-medium mr-[650px] flex justify-center ml-[27rem] mt-[1rem]'>Add Patient Details</p>
            <div className='flex justify-center ml-[10rem] '>
                <form className="w-full max-w-lg">
                    <div className="flex flex-wrap -mx-3 mb-6">
                        ...
                        <div class="flex flex-wrap -mx-3 mb-6">
                            <div className="w-full px-3">
                                ...
                                <input className="appearance-none block w-full bg-[#ffffff] text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white ml-[1rem] w-[32rem] focus:border-gray-500" type="password" />
                            </div>
                        </div>


                        <div className="w-full md:w-1/2 px-3 mt-[-1.5rem] ">
                        ...
                        <div className="w-full md:w-1/2 px-3">
                            <label className="block mr-[12rem] mt-[-1.6rem] tracking-wide text-gray-700 text-xs font-bold mb-2" for="grid-last-name">
                                City
                            </label>
                        ...
                        <div className="w-full md:w-1/2 px-3 mt-[-.5rem] ">
                            <label className="mr-[11rem] block tracking-wide text-gray-700 text-xs font-bold mb-2" for="grid-state">
                                State
                            </label>
                            <input className="appearance-none block w-full bg-[#ffffff] text-gray-700 border border rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" type="text" />
                        </div>
                        <div className="w-full md:w-1/2 px-3 mt-[1.1rem]">
                    ...
                    <div className='mr-[21rem] mt-[-1.5rem]'>
                        <button class="btn btn-outline mr-[1rem] bg-[#082161] text-[#ffffff] capitalize">Submit</button>

                        <button class="btn btn-outline text-[#082161] capitalize">Cancel</button>
                    </div>
                </form>
