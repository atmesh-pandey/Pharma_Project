...
const Middle = () => {
    return (
        <div>
            <div className='flex justify-right h-[13rem] space-x-12 mt-8  ml-56'>
                <div class="overflow-x-auto w-[44rem]">
                    <div className=' ml-10'>
                        <div className='flex justify-between mb-2'>
                            <h4 className='my-1 mx-3'><b>Upcoming Appointment</b></h4>
                            <Link to="/Appointment">
                                <button type="button" className='mx-3 h-8 w-28 bg-[#082161] text-white my-1 rounded-lg'>View all</button>
                            </Link>
                        </div>
                        <table class="table-auto h-28 w-full">
                            ...
                            <tbody>
                                <tr className='text-gray-600'>
                                    ...
                                    <td className='flex justify-center'> Dr. John Doe </td>
                ...
                <div class="overflow-x-auto w-[20rem]">
                    <div className=''>
                        <div className='flex justify-between mb-2'>
                            <h4 className='my-1 mx-3'><b>Doctor List</b></h4>
                            <button type="button" className='mx-3 h-8 w-28 bg-[#082161] text-white my-1 rounded-lg'>View all</button>
                        </div>
                        <table class="table-auto h-28 w-full">
                            <thead >
