            ...
            <div className=" left-0 w-[15%] p-10 pl-10 text-white fixed mt-12">
                <div className='relative mt-[2rem]'>
                    <Link  to="/">
                        ...
                        <a className={["mt-[-5px] left-7 absolute", location.pathname ==="/Home" ? 'text-[#082161] font-bold':"text-slate-500"].join(" ")} href="#">Dashboard</a>
                    </Link>
                </div>
                ...
                <div className='relative mt-[3rem]'>
                    <Link to="/Appointment">
                        ...
                        <a href="#Appointment" className={['absolute left-7 mt-[27px]',location.pathname ==="/Appointment" ? 'text-[#082161] font-bold':"text-slate-500"].join(" ")}>Appointment</a>
                    </Link>
                </div>
                ...
                <div className='relative mt-[3.5rem]'>
                    <Link to="/Staff">
                        ...
                        <a href="#Staff" className={['absolute left-7 mt-[70px]',location.pathname ==="/Staff" ? 'text-[#082161] font-bold':"text-slate-500"].join(" ")}>Staff</a>
                    </Link>
                </div>
                <div className='relative mt-[4rem]'>
                    <Link to="/Order">
                        ...
                        <a href="#Order" className={['absolute left-7 mt-[110px]',location.pathname ==="/Order" ? 'text-[#082161] font-bold':"text-slate-500"].join(" ")}>Orders</a>
                    </Link>
                </div>

                <div className='relative mt-[4.5rem]'>
                    <Link to='/Chat'>
                        <svg width="23" height="24" viewBox="0 0 23 24" fill="none" xmlns="http://www.w3.org/2000/svg" className='absolute mt-[150px]'>
                        ...
                        <a href="#Chat" className={['absolute left-7 mt-[150px]',location.pathname ==="/Chat" ? 'text-[#082161] font-bold':"text-slate-500"].join(" ")}>Chat</a>
                    </Link>
                </div>
                ...
                <div className='relative mt-[5rem]'>
                    <Link to="/Addpatients" >
                        ...
                        <a href="#Addpatients" className={['absolute left-7 mt-[190px]',location.pathname ==="/Addpatients" ? 'text-[#082161] font-bold':"text-slate-500"].join(" ")}>Patients</a>
                    </Link>
                </div>
                ...
                <div className='relative mt-[5.5rem]'>
                    <Link to='/Inventory'>
                        ...
                        <a href="#Inventory" className={['absolute left-7 mt-[230px]',location.pathname ==="/Inventory" ? 'text-[#082161] font-bold':"text-slate-500"].join(" ")}>Inventory</a>
                    </Link>
                </div>
                ...
                <div className='relative mt-[6rem]'>
                    <Link to="/Revenue">
                        ...
                        <a href="#Revenue" className={['absolute left-7 mt-[270px]',location.pathname ==="/Revenue" ? 'text-[#082161] font-bold':"text-slate-500"].join(" ")}>Revenue</a>
                    </Link>
                </div>
                ...
                <div className='relative mt-[6.5rem]'>
                    <Link to="/Setting">
                        ...
                        <a href="#Setting" className={['absolute left-7 mt-[310px]',location.pathname ==="/Setting" ? 'text-[#082161] font-bold':"text-slate-500"].join(" ")}>Settings</a>
                    </Link>
                </div>
