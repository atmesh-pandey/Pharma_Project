...
function Editstaff() {
    return (
        ...
        <Outerheader />
            ...
            <p className='text-[#082161] font-medium mr-[650px] flex justify-center ml-[28rem] mt-[3rem]'>Edit Staff Details</p>
            {/* <div className='relative w-[800px] h-[550px] left-[490px] top-[50px]' >
                <p className='text-[#082161] font-medium mr-[650px]'>Edit Staff Details</p>

                <form>
                    <div className='flex'>
                        <div className='flex flex-col'>
                            <div className="form-control flex flex-col">
                                <label className="label mt-2 mr-[160px]">
                            ...
                            <div className="form-control flex flex-col">
                                ...
                                <select className='bg-[#FFFFFF] ml-[3px] w-[250px] mt-2 rounded-md h-[30px]'>
                                <option value="select">Select</option>
                                <option value="male">Male</option>
                                <option value="female">Female</option>
                            ...
                            <div className="form-control flex flex-col">
                                <label className="label mt-2 mr-[130px]">
                        ...
                        <div className='flex flex-col ml-[100px]'>
                            ...
                            <div className="form-control flex flex-col">
                                <label className="label mt-2 mr-[140px]">
                            ...
                            <div className="form-control flex flex-col">
                                ...
                                <input type="email" className="input input-bordered w-[250px] mt-2 rounded-md h-[30px]" />
                            </div>
                            <div className="form-control flex flex-col">
                                <label className="label mt-2 mr-[170px]">
                            ...
                            <div className='flex'>
                                <svg width="42" height="42" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg" className='mt-9'>
                                ...
                                <input type="file" className='bg-[#FFFFFF] ml-[20px] w-[200px] mt-10 rounded-md h-[30px] text-[10px] p-1' />
                            </div>
                        </div>
                    </div>
