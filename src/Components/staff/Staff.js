    ...
    return (
        <>
            ...
            <div className='flex justify-between ml-[16rem]'>
                ...
                <Link to='/Addstaff'>
                    <button type='button' className=' bg-[#082161] w-[8vw] mr-[7rem] mt-[5rem] text-[#ffffff] h-[6vh] rounded-md '>+ Add Staff</button>
                </Link>
            </div>
            <div className='flex'>
                <p className='text text-xl ml-[20rem]  mb-[500px] text-[#082161] font-[500]'>All Staff</p>
                <input type='text' className="form-control ml-[2rem] block px-4 h-[2.5rem] w-[12rem] p-1 mt-[-.5rem]  text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded-md  transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none drop-shadow-md" placeholder='search here...' />
            </div>

            <div className='relative'>
                <div className='flex   ml-[20rem] mt-[-30rem]'>
                    <table className="table-auto  w-[60rem] h-[25rem]">
                        ...
                        <tbody>
                            <tr className='text-center'>
                                ...
                                <td ><span className='absolute ml-[-28px]'>
                                    <img alt='Staff' src='https://lmsimages.sgp1.digitaloceanspaces.com/user_img.png' />
                                </span><span>Dr. John Doe</span>
                                </td>
                                <td>Dentist</td>
                                <td>999558754</td>
                                    ...
                                    <div className='flex justify-center mt-2'>
                                        <Link to='/Editstaff'>
                                            <div className="tooltip" data-tip="Edit">
                                                <svg className='mx-3' width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <div className="modal">
                                            <div className="modal-box">
                                                ...
                                                <div className="modal-action">
                                                    <label htmlFor="my-modal" className="btn bg-red-500 hover:bg-red-500">Delete</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <tr className='text-center'>
                                <td><input type="checkbox" /></td>
                                <td ><span className='absolute ml-[-28px]'>
                                    <img alt='Staff' src='https://lmsimages.sgp1.digitaloceanspaces.com/user_img.png' /></span><span>Dr. John Doe</span>
                                </td>
                                <td>Dentist</td>
                                <td>999558754</td>
                                <td>xyz@example.com</td>
                            ...
                            <tr className='text-center'>
                                <td><input type="checkbox" /></td>
                                <td ><span className='absolute ml-[-28px]'><img alt='Staff' src='https://lmsimages.sgp1.digitaloceanspaces.com/user_img.png' /></span><span>Dr. John Doe</span></td>
                                <td>Dentist</td>
                                <td>999558754</td>
                                <td>xyz@example.com</td>
                                <td>20-03-1998  </td>
